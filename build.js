...
Fs.readFile(`${dir.SRC}/validate.js`, 'utf-8', (error, data) => {
	...
	Fs.writeFile(`${dir.DIST}/validate.js`, Terser.minify(data).code, 'utf-8', (error, data) => {
		if (error) {
			console.error(`${error}`);
			process.exit(1);
		}
	...
	Fs.writeFile(`${dir.DIST}/validate-es5.js`, Terser.minify(compiled).code, 'utf-8', (error, data) => {
		if (error) {
			console.error(`${error}`);
			process.exit(1);
		}
